...
import { UserCircle, FileText, Phone } from 'lucide-react';
  ...
  return (
    <div className="w-full pb-10">
      <div className="mb-8 flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-brand-text-primary">Add New Driver</h1>
          <p className="text-brand-text-secondary mt-1">Register a new driver or helper.</p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <ThemeSelect 
                    ...
                    className="flex w-full h-12 rounded-xl bg-white border border-gray-200 px-3 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:border-brand-secondary focus-visible:ring-brand-secondary transition-all shadow-sm"
                  />
                  <p className="text-xs text-gray-500 mt-1">Assigning a vehicle here will detach it from any current driver.</p>
                </div>
                <div className="space-y-2 md:col-span-2">
