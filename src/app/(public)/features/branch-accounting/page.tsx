      ...
      <article className="container mx-auto px-4 max-w-5xl">
        <div className="bg-white rounded-3xl shadow-xl shadow-brand-primary/5 p-8 md:p-12">
          ...
          <header className="mb-12 text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight">Multi-Branch Accounting</h1>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 md:order-2 space-y-6">
              <h2 className="text-3xl font-bold text-gray-900">Unified Financial Control</h2>
          ...
          <section className="bg-brand-bg rounded-2xl p-10 text-center border border-brand-primary/10">
            <h3 className="text-2xl font-bold text-brand-primary-dark mb-4">Ready to connect your branches?</h3>
